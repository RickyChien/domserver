		...
		<div class="login-container">
	        ...
	        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
	            <fieldset>
	                ...
	                <div class="clearfix">
	                <input type="text" id="login" class="login_btn" name="login" placeholder="Username">
	                </div>
	                <div class="clearfix">
	                <input type="password" id="passwd" class="login_btn" name="passwd" placeholder="Password">
	                </div>
